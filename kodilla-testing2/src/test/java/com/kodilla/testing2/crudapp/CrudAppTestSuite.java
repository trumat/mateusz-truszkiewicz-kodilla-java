...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://trumat.github.io/";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("matru@protonmail.com");
        driverTrello.findElement(By.id("password")).sendKeys("TajneHaslo1!");
    ...
    private void deleteTaskFromCrudApp(String taskName) throws InterruptedException {
        ...
        driver.findElements(By.xpath("//form[@class=\"datatable__row\"]")).stream()
                .filter(anyForm ->
                        anyForm.findElement(By.xpath(".//p[@class=\"datatable__field-value\"]")).getText().contains(taskName))
                .forEach(theForm -> theForm.findElement(By.xpath(".//button[text()=\"Delete\"]")).click());
        Thread.sleep(2000);
    }

    @Test
    public void shouldCreateTask() throws InterruptedException {
